# Hi, I'm Harsh Kumar Gour 👋

A full-stack developer who likes building things that are fast, real-time, and don't fall apart under pressure.  
Currently studying CS + Cybersecurity @ **IIIT Kottayam** — but most of my time goes into shipping backend systems and distributed apps.
...
- 👨‍💻 **Technical Lead @ BeatLabs Web 3.0 Club** — ran workshops on backend architecture, REST API design & distributed systems for 50+ students; mentored 5+ devs on React, Node.js, and Docker
- 🏆 **Smart India Hackathon 2024** — selected from 180+ participants; prototype hit 90%+ functionality at final eval
- 🎓 **B.Tech CS + Cybersecurity** @ IIIT Kottayam (2023–2027)
